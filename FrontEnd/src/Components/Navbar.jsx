    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-slate-950/85 backdrop-blur-xl">
      <div className="mx-auto flex min-h-18 max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span>
            <span className="block text-base font-extrabold tracking-[0.08em] text-white sm:text-lg">
              PROJECT LOOP
            </span>
        ...
        <div
          className={`${
            open ? "flex" : "hidden"
          } absolute left-4 right-4 top-[72px] flex-col gap-2 rounded-2xl border border-white/10 bg-slate-950/95 p-4 shadow-2xl backdrop-blur-xl lg:static lg:flex lg:flex-row lg:items-center lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none`}
        >
